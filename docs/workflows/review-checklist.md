...
- Admin API accepts only valid payloads (`POST/DELETE /api/admin/communities`)
- Sidebar navigation stays coherent for the current role
- Shared foundation routes still load (`/dashboard/communities`, `/dashboard/community`, `/dashboard/checkout`)
